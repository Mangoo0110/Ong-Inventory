                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: Text("Create Product", style: AppTextStyle().boldNormalSize(),),
                      ),
                    ),
                              ...
                              child: Form(
                                ...
                                child: CustomTextfield(
                                  onValidate: (text) {
                                    ...
                                    if(existingProductSet.contains(text)){
                                    ...
                                    child: InkWell(
                                      onTap: () async{
                                        if(_priceFormKey.currentState!.validate() && _productNameformKey.currentState!.validate()) {
                                          await ProductDomain().createProduct(
